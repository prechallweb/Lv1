      ...
      <main className="styles__Container-sc-7069b3c5-0 hnjHY">
        <div className="formInner">
          <ul className="tabList">
            <li><Link className="title-md active" href="/find/id">아이디 찾기</Link></li>
            <li><Link className="title-md" href="/find/pw">비밀번호 찾기</Link></li>
          </ul>

          <form className="styles__Container-sc-4b638756-0 dphPPe" onSubmit={handleSubmit}>
            <fieldset>
              <legend className="sr-only">아이디 찾기</legend>
              <div className="email">
              ...
              <div className="btnWrap">
                <button type="submit" className="styles__Button-sc-163293cd-0 bNUQQg title-md">아이디 찾기</button>
                <Link href="/login">
